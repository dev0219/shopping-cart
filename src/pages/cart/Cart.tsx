                ...
                <div className="shopping-list-item__action-wrapper">
                  <div className="shopping-list-item__action-wrapper-counter">
                    <div className="increment-decrement counter">
                      <div style={{ fontSize: "15px" }} className="counter__trash counter-button" onClick={() => changeQuantity(index, 'decrease')}>
                      ...
                      <div style={{ fontSize: "15px" }} className="counter__increment counter-button" onClick={() => changeQuantity(index, 'increase')}>
