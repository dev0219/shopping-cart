...
const index = ({ pro, index, onchangeQuantity, oncloseItem, onmoveItem, onlinkDetail, oncheckProduct }: any) => {
  return (
    <div className="shopping-list-item__details">
      <div className="shopping-list-item__wrapper" onClick={() => onlinkDetail(pro.upc)}>
        <input className="shopping-list-item__checkbox-input" type="checkbox" onChange={(e: any) => oncheckProduct(pro, e.target.checked)} checked={pro.isChecked} />
        {pro.image != '' &&
      ...
      <div className="shopping-list-item__action-wrapper">
        <div className="shopping-list-item__action-wrapper-counter">
          <div className="increment-decrement counter">
            <div className="counter__trash counter-button" onClick={() => onchangeQuantity(pro, 'decrease')}>
              {pro.quantity > 1 ? <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-dash" viewBox="0 0 16 16">
            ...
            <div className="counter__increment counter-button" onClick={() => onchangeQuantity(pro, 'increase')}>
